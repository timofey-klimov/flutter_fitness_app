...
class _WeightApproachWidgetState extends State<WeightApproachWidget> {
  ...
  @override
  void initState() {
    weightDebounce = Debounce(duration: const Duration(milliseconds: 700));
    countDebounce = Debounce(duration: const Duration(milliseconds: 700));
    super.initState();
  }
